...
export const professionals: Professional[] = [
  {
    ...
    role: 'Fundadora · Tricologia Avançada',
    unit: 'tricologia',
    photo: '/team/danusa-pires.webp',
    bg: '#2A2A2A',
    ig: '@dradanusa',
    description:
      'Após 18 anos atuando em emergências, a Dra. Danusa construiu uma forma diferente de cuidar — com tempo e método. Desde 2022 dedica-se exclusivamente à tricologia avançada, conduzindo avaliações estruturadas, planejando protocolos individualizados e acompanhando a evolução de cada paciente.',
