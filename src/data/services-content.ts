/**
 * Conteúdo detalhado dos serviços clínicos da Danusa Pires (brand v4).
 * 7 linhas conforme docs/BRAND.md: queda-feminina, alopecia-androgenetica, pos-transplante,
 * fortalecimento, trichotest, soroterapia (página própria), diagnostico, + inflamacoes-couro
 * mantido como complementar (casos leves apenas, graves: encaminhar).
 *
...
export const services: Record<string, ServiceContent> = {
  ...
  'alopecia-androgenetica': {
    ...
    hero: {
      eyebrow: 'serviço · alopecia androgenética',
      title: 'Alopecia androgenética.',
      emphasis: 'androgenética',
      lead: 'Avaliação clínica da alopecia androgenética em homens e mulheres. Protocolo individualizado conforme fase, evolução e expectativa do paciente. Conduta complementar ao pré e pós cirurgia capilar.',
      image: 'clinical/scalp-male-closeup',
    },
    problem:
      'A alopecia androgenética segue um padrão visualmente reconhecido, mas a evolução é variável entre indivíduos. Conduta sem leitura clínica subestima a velocidade do quadro ou supervaloriza intervenções com pouco retorno.',
    mechanism:
      'Sensibilidade folicular à di-hidrotestosterona (DHT) leva à miniaturização progressiva dos fios em áreas geneticamente determinadas: entradas, coroa, vértice em homens; afinamento difuso na linha central em mulheres. A leitura instrumental quantifica miniaturização e identifica a fase do quadro.',
    intervention: [
  ...
  'trichotest': {
    slug: 'trichotest',
    hero: {
      eyebrow: 'serviço · genética capilar',
      title: 'TrichoTest.',
      emphasis: 'TrichoTest',
      lead: 'Análise genética aplicada ao protocolo capilar. Quando justificado, o teste orienta escolha de ativos e identifica predisposições para personalizar a conduta de longo prazo.',
      image: 'clinical/trichoscopy-exam',
    },
    problem:
      'Parte dos quadros capilares responde de forma irregular a protocolos padronizados. A variabilidade individual em metabolismo de ativos, sensibilidade hormonal e fatores nutricionais cria zonas cinzas no plano terapêutico.',
    mechanism:
      'O TrichoTest analisa marcadores genéticos relacionados a metabolismo de ativos tópicos, sensibilidade androgenética, resposta inflamatória, ciclo folicular e absorção nutricional. A leitura orienta escolha de princípios ativos e antecipa potenciais não-respondedores.',
    intervention: [
      'Indicação criteriosa após leitura clínica inicial (não é exame de triagem).',
      'Coleta de material genético padronizada.',
      'Interpretação clínica do resultado integrada ao quadro atual.',
      'Ajuste do protocolo capilar conforme marcadores relevantes.',
    ],
    outcome:
      'Plano terapêutico mais preciso em casos selecionados. Reduz tentativa e erro em pacientes que já passaram por protocolos sem resposta consistente. Resposta variável conforme padrão fisiológico individual.',
    indications: [
      'Quadros sem resposta a protocolos prévios bem conduzidos',
      'Pacientes que buscam protocolo premium individualizado',
      'Casos com histórico familiar complexo',
      'Antes de investimento longo em protocolos cirúrgicos ou medicamentosos',
    ],
    faqs: [
      {
        q: 'TrichoTest é necessário pra todo paciente?',
        a: 'Não. É indicado em casos selecionados, geralmente após uma primeira leitura clínica. Para a maioria, o protocolo padrão da clínica já entrega bom resultado.',
      },
      {
        q: 'Qual o prazo do resultado?',
        a: 'O laboratório entrega entre 2 e 4 semanas após a coleta. A devolutiva clínica é feita em consulta presencial ou online.',
      },
    ],
  },
